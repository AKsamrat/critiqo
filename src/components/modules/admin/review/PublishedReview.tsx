...
const PublishedReview = ({ reviewData }: { reviewData: any }) => {
  ...
  const filtered = reviews?.filter((r: any) => r.status === "PUBLISHED");

  return (
    <div>
      <p className="text-2xl font-bold py-4">All Published Review</p>
