  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-12  mx-auto">
      <div className="container max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 pl-2  gap-8 ">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-4">
              {featureds?.highestRated?.map((review: TReview) => (
                <div
                  key={review.id}
                  className="bg-gray-800 hover:bg-gray-900 hover:scale-110  duration-700 border-gray-200 shadow-md hover:shadow-lg rounded-xl p-2"
                >
